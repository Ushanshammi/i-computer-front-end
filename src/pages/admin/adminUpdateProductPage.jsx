...
const location=useLocation();//give edit button data
...
async function updateProduct(){
    ...
    return(
        ...
        <div className="w-full  p-[50px] flex justify-center  overflow-y-scroll ">
            ...
            <h1 className="flex justify-center pb-[30px] text-2xl font-bold items-center gap-[15px]" ><MdOutlineAddShoppingCart/>Update Product</h1>
                ...
                <div className="w-full bg-white p-[20px] flex flex-wrap justify-between rounded-xl">
                            ...
                            <div className=" flex flex-col my-[10px] mb-[30px] w-[40%]">
                                 ...
                                 <button onClick={updateProduct} className=" w-[45%] mt-[30px] h-[50px] bg-accent font-bold text-[20px] rounded-2xl hover:bg-gray-500 hover:text-white ">Update Product</button>
